...
3. **Movie Details** – View poster, release date, and metadata.  
4. **Series & Episodes** – Manage series/episode data.  
5. **Light/Dark Mode** – Theme toggling.  
6. **Responsive Design** – Optimized for desktop & mobile.  
7. **Protected Routes** – Certain features require authentication.  
...
- **Fetch API** – Async requests to movie API.  
